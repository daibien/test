      ...
      class First_Theme_Options {
		...
		**/
		public function setArguments() {
		    ...
		    $this->args = array(
		            ...
		            'menu_type'          => 'menu',
		        'allow_sub_menu'     => true,
		        'menu_title'         => __( 'TP Theme Options', 'itc' ),
		        'page_title'         => __( 'TP Theme Options', 'itc' ),
		        'dev_mode' => false,
		        'customizer' => true,
		...
		**/
		public function setHelpTabs() {
		    ...
		    $this->args['help_tabs'][] = array(
		        'id'      => 'redux-help-tab-1',
		        'title'   => __( 'Theme Information 1', 'itc' ),
		        'content' => __( '<p>This is the tab content, HTML is allowed.</p>', 'itc' )
		    );
		 
		    $this->args['help_tabs'][] = array(
		        'id'      => 'redux-help-tab-2',
		        'title'   => __( 'Theme Information 2', 'itc' ),
		        'content' => __( '<p>This is the tab content, HTML is allowed.</p>', 'itc' )
		    );
		 
		    // Set the help sidebar
		    $this->args['help_sidebar'] = __( '<p>This is the sidebar content, HTML is allowed.</p>', 'itc' );
		}
		/**
		...
		**/
		public function setSections() {
		    ...
		    $this->sections[] = array(
		        'title'  => __( 'Header', 'itc' ),
		        'desc'   => __( 'All of settings for header on this theme.', 'itc' ),
		        'icon'   => 'el-icon-home',
		        'fields' => array(
					    ...
					    array(
					        'id'       => 'logo-on',
					        'type'     => 'switch',
					        'title'    => __( 'Enable Image Logo', 'itc' ),
					        'compiler' => 'bool', // Trả về giá trị kiểu true/false (boolean)
					        'desc'     => __( 'Do you want to use image as a logo?', 'itc' ),
					        'on' => __( 'Enabled', 'itc' ),
					        'off' => __('Disabled')
					    ),
					    ...
					    array(
					        'id'       => 'logo-image',
					        'type'     => 'media',
					        'title'    => __( 'Logo Image', 'itc' ),
					        'desc'     => __( 'Image that you want to use as logo', 'itc' ),
					    ),
					)
		    ); // end section
		 	// Typography Section
        ...
        global $reduxConfig;
        $reduxConfig = new First_Theme_Options();
      }
 ?>